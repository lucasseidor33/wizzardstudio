...
// 👇 Importás EB Garamond solo en este componente
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center px-6 w-full max-w-7xl mx-auto gap-8 md:gap-12">
        ...
        <div className="w-full md:w-3/5 flex flex-col items-center md:items-start text-center md:text-left">
          <div className="flex flex-col items-center md:items-start">
            <h1
              id="hero-heading"
              className={`text-7xl md:text-9xl font-bold tracking-widest leading-none ${ebGaramond.className}`}
              style={{
                letterSpacing: "0px",
                textShadow:
            ...
            <h1
              className={`text-7xl md:text-9xl font-bold tracking-widest leading-none mt-2 md:mt-4 md:ml-16 ${ebGaramond.className}`}
              style={{
                letterSpacing: "8px",
                textShadow:
                  "0 4px 12px rgba(0, 0, 0, 0.5), 0 2px 4px rgba(0, 0, 0, 0.3)",
